(function() {
 ...
 var ACE3FacebookSecureUserMatchingHost = "https://secure.leadback.advertising.com";
 ...
 var ACErtbCheck = function(site, region) {
  if (!document.getElementById("ACE3RTBPingFile") && Math.floor(Math.random() * 100) + 1 <= ACE3RTBglobalThrottle) {
   ...
   if (document.location.protocol === "https:") {
    rtbPing.src = ACE3FacebookSecureUserMatchingHost + "/cfcm.ashx?providerid=1011" + rcode + "&site=" + site;
   } else {
    rtbPing.src = ACE3UserMatchingHost + "/um.ashx?site=" + site + rcode;
   }
 ...
 var doUserMatchingCalls = function(exchmap, site, region) {
  if (exchmap != "0") {
 ...
 window["ACE3_AdRequest"] = function(obj) {
  ...
  var r = "region" in obj ? parseInt(obj["region"], 10) : 0;
  if (r != 2 && r != 3 && r != 4) {
   r = 1;
  }
  ot += "/r=" + r;
  ...
  if (pNo) {
   ...
   document.write(dw);
   doUserMatchingCalls(obj["exchmap"], site, obj["region"]);
  }
  window["ACE_KeyParm"] = "";
  window["ACE_KeyParms"] = "";
  window["ACE_AR"] = "";
