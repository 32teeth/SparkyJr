...
public class SparkyOfficial extends PApplet {
...
{  
  ...
  */  
  public void set(int address, long clr)
  {    
    if(open)
    {
...
{  
  ...
  */     
  ...
  public void preview(int r, int g, int b)
  {
    /*
...
{  
  ...
  */  
  ...
  public void display()
  {
    ...
    {
      fill(0xff777777);
      if(states[n] == 0){fill(0xff666666);};
      if(selected[n] == 1){fill(0xff999999);};    
      Base = buttons.getChild("Base"+n);
      Base.disableStyle();
      shape(Base, dx, 0);
  ...
  public void madcatz()
  {
    ...
    {
      fill(0xff777777);
      if(MADCATZ[n] == 1){fill(0xff999999);}; 
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "--full-screen", "--bgcolor=#666666", "--hide-stop", "SparkyOfficial" };
    if (passedArgs != null) {
